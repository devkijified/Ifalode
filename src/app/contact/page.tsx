...
// ============================================================
// Main Contact Content Component (uses useSearchParams)
// ============================================================
                ...
                {!loading && user && (
                  <div ref={accountRef} className="relative">
                    ...
                    >
                      ...
                      <span className={`text-slate-500 text-xs transition-transform ${accountOpen ? 'rotate-180' : ''}`}>▾</span>
                    </button>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-brand-primary/20 bg-brand-primary/5 px-3.5 py-2 mb-7">
              ...
              <span className="text-xs font-semibold text-brand-primary">Get in touch</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl leading-[.98] font-black tracking-[-0.045em]">
              Reach out for
              <br />
              <span className="text-brand-primary">guidance and support.</span>
            </h1>
            ...
            <div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5 sm:p-6">
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                  ...
                  <div>
                    <label htmlFor="location" className="block text-xs font-semibold text-slate-400 mb-1">Location (city & country)</label>
                    <input
                      id="location"
                      type="text"
                      required
                  ...
                  <div>
                    <label htmlFor="service" className="block text-xs font-semibold text-slate-400 mb-1">Service interested in</label>
                    <select
                      id="service"
                      value={form.service}
                    ...
                    >
                      <option value="consultation">Ifá Consultation</option>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs font-semibold text-slate-400 mb-1">Message</label>
                    <textarea
                      id="message"
                      required
                      value={form.message}
