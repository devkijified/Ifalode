...
type Teaching = {
  id: string
  category: 'LESSON' | 'INSIGHT' | 'ODU STUDY' | 'PRACTICE'
  title: string
  description: string
  date: string
  href: string
  ...
  const teachings: Teaching[] = [
    {
      ...
      description:
        'Exploring the role of the inner head in destiny, choices, and spiritual alignment.',
      date: 'Aug 2026',
      href: '/teachings/ori',
    },
    {
      ...
      description:
        'What it means to walk in goodness, and how to cultivate ire in daily life.',
      date: 'Jul 2026',
      href: '/teachings/ire',
    },
    {
      ...
      description:
        'How the Odu speak through signs, stories, and patterns in your life.',
      date: 'Jun 2026',
      href: '/teachings/odu-language',
    },
    {
      id: 'ebo',
      category: 'PRACTICE',
      ...
      description:
        'The purpose of offerings and how they work within the Ifá system.',
      date: 'May 2026',
      href: '/teachings/ebo',
    },
    {
      ...
      description:
        'Why good character is the foundation of any serious spiritual path.',
      date: 'Apr 2026',
      href: '/teachings/iwa-pele',
    },
    {
      id: 'destiny',
      category: 'INSIGHT',
      ...
      description:
        'How Ayanmo and personal choice interact in the Ifá worldview.',
      date: 'Mar 2026',
      href: '/teachings/destiny',
    },
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base sm:text-lg leading-8 text-slate-400">
              ...
              Selected teachings from Akinsoji Elebuibon on the Odu, Ìwà Pẹ̀lẹ́,
              destiny, and practical spiritual living. These are meant to
              support understanding, not replace personal consultation.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 rounded-2xl border border-slate-800 bg-slate-900/50 p-5 sm:p-6">
            ...
            <p className="text-sm text-slate-400">
              ...
              More teachings will be added over time. If there is a topic you
              would like Akinsoji to address, you can mention it when you{' '}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-800">
        ...
        <span className="text-[11px] text-slate-600">{teaching.date}</span>
